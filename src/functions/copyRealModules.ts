 ...
 * @returns {undefined}
 */
export const copyRealModules = (destModulesDir: string, moduleNames: string[], sourceModulesDir: string = './node_modules'): void =>
  moduleNames.forEach(
    (moduleName: string): void => cpSync(`${sourceModulesDir}/${moduleName}`, `${destModulesDir}/${moduleName}`, { recursive: true })
  )
